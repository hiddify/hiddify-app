...
class SingboxNativeLibrary {
  ...
  late final _parseCli = _parseCliPtr
      .asFunction<
        ffi.Pointer<ffi.Char> Function(int, ffi.Pointer<ffi.Pointer<ffi.Char>>)
      >();
  ...
  late final _startCommandClientPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Int, ffi.LongLong)
        >
      >('startCommandClient');
  ...
  late final _StartCoreGrpcServer =
      _StartCoreGrpcServerPtr.asFunction<
        ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
      >();
}
