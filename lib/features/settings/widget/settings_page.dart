                  ...
                  children: [
                    ...
                    _SettingsTile(
                      ...
                      trailing: Switch(
                        value: debugMode,
                        onChanged: (val) =>
                            unawaited(ref.read(debugModeProvider.notifier).update(value: val)),
                      ),
                    ),
                    if (debugMode) ...[
                      const Divider(height: 1),
                      _SettingsTile(
                        ...
                        onTap: () => unawaited(_runConnectionStressTest(context, ref)),
                      ),
                    ],
                    const Divider(height: 1),
                    _SettingsTile(
...
Future<void> _runConnectionStressTest(BuildContext context, WidgetRef ref) async {
  const cycles = 20;
  ...
  for (var i = 1; i <= cycles; i++) {
    ...
    Logger.app.info('Stress test: cycle $i/$cycles - connect');
    ...
    Logger.app.info('Stress test: cycle $i/$cycles - disconnect');
