...
abstract class ConfigOptions {
  ...
  static final Map<String, NotifierProvider<PreferencesNotifier<dynamic, dynamic>, dynamic>> preferences = {
    "region": region,
    "block-ads": blockAds,
  ...
  static final singboxConfigOptions = FutureProvider<SingboxConfigOption>((ref) {
    ...
    return Future.value(SingboxConfigOption(
