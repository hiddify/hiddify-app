...
typedef FreeCStringFunc = Void Function(Pointer<Utf8> str);
typedef FreeCString = void Function(Pointer<Utf8> str);

typedef CFreeFunc = Void Function(Pointer<Void> ptr);
typedef CFree = void Function(Pointer<Void> ptr);
  ...
  CoreService() {
    if (!Platform.isAndroid && !Platform.isIOS) {
       ...
       try {
         ...
         if (_freeCString == null && Platform.isWindows) {
           try {
             final crt = DynamicLibrary.open('ucrtbase.dll');
             _fallbackFree = crt.lookup<NativeFunction<CFreeFunc>>('free').asFunction();
           } catch (_) {
             _fallbackFree = null;
           }
         }
      ...
      if (resultPtr != nullptr) {
        ...
        try {
          if (_freeCString != null) {
            ...
            _fallbackFree?.call(resultPtr.cast<Void>());
          }
        } catch (_) {}
        return error;
      }
