...
class AutoAppsSelectionModal extends HookConsumerWidget {
  ...
  String _genSliderText(Translations t, int sliderValue) {
    final day = t.profile.interval.day(n: sliderValue);
    return day;
  }
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: Column(
          children: [
            ListTile(
              title: Text(t.settings.network.autoSelection.title),
                            ...
                            children: [
                              Expanded(
                                child: FilledButton(
                                  ...
                                  child: Text(t.settings.network.autoSelection.performNow),
                                ),
                              ),
                              const Gap(8),
                              FilledButton.tonal(
                                ...
                                child: Text(t.settings.network.autoSelection.resetToDefault),
                              ),
                            ],
                          ),
                        ),
