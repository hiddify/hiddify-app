...
class MyAdaptiveLayout extends HookConsumerWidget {
  ...
  List<ShellRouteAction> _actions(Translations t, bool showProfilesAction, bool isMobileBreakpoint) => [
        ...
        if (showProfilesAction && !isMobileBreakpoint) ShellRouteAction(Icons.view_list_rounded, t.profile.overviewPageTitle),
        ShellRouteAction(Icons.settings_rounded, t.config.pageTitle),
        if (!isMobileBreakpoint) ShellRouteAction(Icons.description_rounded, t.logs.pageTitle),
        if (!isMobileBreakpoint) ShellRouteAction(Icons.info_rounded, t.about.pageTitle),
      ];
