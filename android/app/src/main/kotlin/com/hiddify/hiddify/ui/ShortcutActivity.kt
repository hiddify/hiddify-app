...
import com.hiddify.hiddify.core.service.ServiceConnection
import com.hiddify.hiddify.core.constant.Status

class ShortcutActivity : Activity(), ServiceConnection.Callback {

    private val connection by lazy { ServiceConnection(this, this, false) }
    ...
    override fun onServiceStatusChanged(status: Status) {
        when (status) {
            ...
            Status.Stopped -> BoxService.start(this)
            else -> {}
        }
        finish()
    }
